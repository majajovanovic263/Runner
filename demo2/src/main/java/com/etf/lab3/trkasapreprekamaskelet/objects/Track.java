...
public class Track extends Group 
{
	...
	public Track() 
	{
		...
		Image lineimg = new Image("file:///Users/majajovanovic/IdeaProjects/demo2/src/main/java/com/etf/lab3/trkasapreprekamaskelet/tartan.jpg");
		TRACK_MATERIAL.setDiffuseMap(lineimg);
		Image grassimg = new Image("file:///Users/majajovanovic/IdeaProjects/demo2/src/main/java/com/etf/lab3/trkasapreprekamaskelet/grass.jpg");
		GRASS_MATERIAL.setDiffuseMap(grassimg);
