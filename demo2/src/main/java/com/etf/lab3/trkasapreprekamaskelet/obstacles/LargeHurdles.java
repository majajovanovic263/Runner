...
public class LargeHurdles extends ObstacleBody{
    ...
    public LargeHurdles(Position position) {
        super(position);
    }

    @Override
    protected void createObstacleBody() {
        Box b1 = new Box(4,44,4);
        ...
        b1.getTransforms().addAll(
                new Translate(-12,-22,0)
        );
        b2.getTransforms().addAll(
                new Translate(-12,-44,0)
        );
        b3.getTransforms().addAll(
                new Translate(-8,-44,0)
        );
        b4.getTransforms().addAll(
                new Translate(-4,-44,0)
        );
        b5.getTransforms().addAll(
                new Translate(0,-44,0)
        );
